                    ...
                    <tr class="danger">
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                %>
                                <% if (!hasEAC) { %>
                                    <button class="btn btn-secondary" onclick="openEACForm(${patient.patientId})" title="Open Enhanced Adherence Counselling form">
                                        📋 EAC
                                    </button>
                                <% } else { %>
...
function openEACForm(patientId) {
    console.log('[CDS IIT List] Opening EAC form for patient:', patientId);
